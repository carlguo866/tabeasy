# Generated by Django 3.2.14 on 2022-09-04 22:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tourney', '0002_auto_20220814_2022'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paradigm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preferences', related_query_name='preference_scale', to='tourney.paradigm')),
                ('paradigm_preference', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='paradigm_preference_items', related_query_name='paradigm_preference_items', to='tourney.paradigmpreference')),
            ],
        ),
    ]
